...
def CreateHemaPieces():
    ...
    DoubleSquare = Piece(shape=[Vector(0,1),Vector(1,-1),Vector(0,1),Vector(0,1),Vector(1,0),Vector(0,-1)],name="OO",relevantTrans=[Trans.UpFront,Trans.RightFront,Trans.UpBack,Trans.RightBack])
